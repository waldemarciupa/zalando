                                ...
                                category.map(category => {
                                    return (
                                        <StyledListItem key={category.id}>
                                            <StyledLink href={`/categories/${category.id}`}>{category.name}</StyledLink>
                                        </StyledListItem>
                                    )
                                })
                            }
                        ...
                        </StyledButton>
                        {
                            isLoginHover && <StyledMiniBox>
                                ...
                                <StyledMiniLoginTextWrapper>
                                    <StyledLinkToRegister href='/register'>Jesteś nowym klientem? </StyledLinkToRegister>
